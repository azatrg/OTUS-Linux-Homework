...
Что добавить в provision.
sudo yum install epel-release -y && sudo yum install spawn-fcgi php php-cli mod_fcgid httpd wget -y
...
5. Добавклю в юнит файл сервиса httpd параметр %I , также переименую его в httpd@.service.
